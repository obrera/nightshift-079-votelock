      ...
      <Card className="max-w-3xl border-border/60">
        <CardHeader className="gap-2">
          ...
          <CardDescription className="max-w-2xl text-sm/6">
            Nightshift 079 Votelock Seed is a starter for Solana apps that need wallet connection, signing flows,
            cluster switching, and a polished React UI from day one.
          </CardDescription>
        </CardHeader>
